...
namespace Dexcom.Models {
    public class Calibration : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new Calibration and sets the default values.
        /// </summary>
        public Calibration() {
        ...
        public static Calibration CreateFromDiscriminatorValue(IParseNode parseNode) {
